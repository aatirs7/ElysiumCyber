...
export default function GenericSection(props) {
    const { elementId, colors, backgroundImage, badge, title, subtitle, text, actions = [], media, styles = {}, enableAnnotations, sectionIndex } = props;
    const isHero = sectionIndex === 0;
    ...
    return (
        <Section
            ...
            {...getDataAttrs(props)}
        >
            <ScrollReveal animate={isHero} delay={isHero ? 0.2 : 0}>
                <div
